<div class='mini-menu-con-dimmer'>
	<div class='mini-menu-con-container'>
		...
		<div class='mini-menu-tx2-block'>
			<p>
				 Я рад приветствовать вас на данном сайте, <br> надеюсь вам все понравиться, но проект еще не доработан, но обо всех его функциях вы можете узнать <a href="/about"> здесь.</a><br>
				 Если у вас возникли вопросы, идеи, или вы нашли ошибку, то обязательно свяжитесь с нами. Мы ценим ваше мнение.<br>
...
<div class='menu-con-container'>
	...
	<div class="menu-con-outer">
		<div class="menu-con-inner">
			...
			<a href='mailto:voronovnr_1@mail.ru' target="_blank">
			<div class="menu-btn-select">
				<span>Fredback</span>
			</div>
			</a>
